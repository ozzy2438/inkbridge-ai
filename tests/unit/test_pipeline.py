...
from src.pipeline.layout_analysis import BoundingBox, LayoutAnalyzer
...
class TestConfidenceRouter:
    ...
    def test_force_vlm(self):
        ...
        quality = QualityReport(
            passed=True, score=0.9, issues=[], metrics={}, recommendation="process"
        )
        layout = PageLayout(
            page_id="test", width=600, height=800, lines=[], metadata={"handwriting_lines": 5}
        )
