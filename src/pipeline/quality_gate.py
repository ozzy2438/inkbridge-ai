...
class ImageQualityGate:
    ...
    def _detect_glare(self, gray: np.ndarray) -> bool:
        ...
        return bool(bright_ratio > 0.05)  # >5% of image is saturated
    ...
    def _detect_blank(self, gray: np.ndarray) -> bool:
        ...
        return bool(content_ratio < 0.01)  # Less than 1% content

    def _calculate_score(self, metrics: dict[str, object], issues: list[QualityIssue]) -> float:
