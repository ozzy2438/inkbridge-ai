...
class TranscriptExporter:
    ...
    def _export_json(self, results: dict, job_id: str, include_metadata: bool, include_confidence: bool) -> tuple[bytes, str, str]:
    ...
    def _export_docx(self, results: dict, job_id: str) -> tuple[bytes, str, str]:
        ...
        return content, "application/vnd.openxmlformats-officedocument.wordprocessingml.document", f"inkbridge_{job_id}.docx"
